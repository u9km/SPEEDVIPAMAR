...
// ============================================================================
// قائمة الحظر الكاملة (تم تنسيق القائمة التي أرسلتها لتناسب الكود)
// ============================================================================
static const char *blockedStrings[] = {
    ...
    "checkFileSignature", "checkForPatches", "checkGameplayParticipation", "checkImportTable",
    "checkIntegrity", "checkLicense", "checkMemorySignature", "checkModIntegrity",
    ...
    "EasyAntiCheat", "emailProtection", "EmoteData", "Emulator", "EmulatorJailbreakRootDetection",
    ...
    "GCloudVoice", "GCloudVoiceEngine", "GCloudVoiceEngine integrity", "GCloudVoiceHttp",
    "GCloudVoice network checks", "generateLiveReport", "generateSessionKey", "generateSignature",
    "GenerateSignature", "getenv", "gettimeofday", "ghost_report_blocker",
    "GrenadeDamageRecordItem", "GSDKInnerRealTimeDetect", "GSDKInGameBlockInvoke",
    "GSDKInGameSystem", "GSDKLoginEvent", "GSDKReportEvent", "GSDKUdpDetect",
    "GSDKUdpGetSendData", "GSDKUdpHeavy", "GSDKUdpSendV6", "GSDKUdpStartTest",
    "GSDKUdpStartTest2", "guardFunctionEntry", "guardFunctionExit", "hasPendingCrashReport",
    "HBCheck", "HeadShoot", "HeadShootCount", "heap_canary_check", "heapProtectionEnable",
    "hideStringsFromReverse", "hookEnable", "Hooked_ACH", "iAppVersion", "iCPUName",
    "iDevHwModel", "iDevIDFV", "iDevSysVer", "IFSArchiveInterface", "ignoreCommands",
    ...
    "logAIPerception", "logErrorQueues", "LogErrorQueues", "logPathFollowing", "logReportUrl",
    "logSecurityEvents", "LuaActivityCommercializeGamePlayPetPetExhibitFeature",
    "LuaDevGMLuaFeaturePlayerCharacterFlyFeature", "LuaModBaseModGamePlayComponentWeatherComponent",
    ...
    "OnListenerUnregistered", "OnListenerUpdated", "OnMissPlayerDamageRecord", "OnMoveCompleted",
    "overrideSignatureCheck", "PathExist", "PayloadProtection", "pattern_detection",
    "pattern_recognition_trigger", "PerformConditionCheck", "PerformConditionCheckAI",
    "performKernelScan", "PickupCount", "PLCrash integration", "PLCrashReporter",
    "PLCrashReporter init", "PLCrashReporter init (IMSDK integration)", "PlayerCar",
    "PlayerCarSpeedAvg", "PlayerCarSpeedMax", "PlayerCharacterComponent", "PlayerCreepMoveDis",
    "PlayerCreepMoveTime", "PlayerDriveMoveDis", "PlayerDriveMoveTime", "PlayerKillAI",
    "PlayerKillAIInfo", "PlayerMoveDis", "PlayerRunMoveDis", "PlayerRunMoveTime", "PlayerSpeedAvg",
    "PlayerSpeedMax", "PlayerSquatMoveDis", "PlayerSquatMoveTime", "pointer_authentication",
    "preventDebugging", "preventDuping", "preventIdleExploit", "preventReplayAttacks",
    "processCommands", "ProcessCommands", "ProductVersion", "profile_shield", "protectAssets",
    "protectFromDDOS", "protectLuaFeatures", "protectNetwork", "ptrace", "pthread_yield",
    "purgePendingCrashReport", "qos_cnt", "qos_filt", "qos_%d", "Radware",
    "randomness_analysis_aim", "RealtimeMoveSpeedCheck", "RecoveryCount", "RecoveryMax",
    ...
    "VirtualBox", "VirtualMachine", "VNG", "VNGQueue", "VO_CacheVelocity", "VO_Duration",
    "VO_ObstacleCenter", "VO_Obstacles", "VO_OriginLoc", "VO_Step", "VO_Velocity",
    ...
    "antiTamperEnable", "BeingDebugged", "monitoring", "detection", "checkPlayerActivity",
    "detectIdlePlayer", "verifyChecksum", "monitorNetworkActivity", "validateEnvironment",
    "enableCrashReporter", "generateLiveReport", "validateIdentifier", "verifyPurchase",
    "checkIntegrity", "detectTampering", "monitorSystemCalls", "authenticateSession",
    "stack_canary_check", "control_flow_integrity", "stack_frame_setup", "logSecurityEvents",
    "trackResourceUsage", "checkSystemTime", "generateSecurityLog", "memory_barrier",
    "return_sequence", "function_prologue", "checkFileModification", "encryptNetworkData",
    "preventDebugging", "validateBinaryIntegrity", "detectDebuggerAttached",
    "verifyDigitalSignature", "authenticateLicenseKey", "establishSecureChannel",
    "encryptNetworkData", "decryptNetworkData", "secureHandshake", "verifyServerCertificate",
    "validateSessionToken", "authenticateConnection", "generateSessionKey", "deriveEncryptionKey",
    "implementPerfectForwardSecrecy", "preventReplayAttacks", "detectMITM", "verifyMessageIntegrity",
    "signData", "verifySignature", "protectAgainstEavesdropping", "implementEndToEndEncryption",
    "secureKeyExchange", "validateProtocolVersion", "enforceEncryptionPolicy", "heap_canary_check",
    ...
    "preventIdleExploit", "monitorInputFrequency", "checkResponseTime", "verifyRealTimeAction",
    "enforceMinimumActivity", "detectBotBehavior", "enableCrashReporter", "generateLiveReport",
    "setCrashCallbacks", "hasPendingCrashReport", "loadPendingCrashReportData",
    "purgePendingCrashReport", "validateIdentifier", "validateAppID", "validateURLSchemes",
    "checkRegisteredCanOpenURLScheme", "validateFacebookReservedURLSchemes",
    ...
    "crypto_layer_2", "crypto_layer_3", "integrity_checker", "tamper_detection",
    "self_healing_system", "quantum_protection", "temporal_shield", "neural_defense",
    "blockchain_valida"detectDebuggerAttached",
